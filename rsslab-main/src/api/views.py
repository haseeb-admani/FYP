...
def gender_dist_graph(request):
    ...
    if(startDate != "" and endDate != ""):
        ...
        # endDate = datetime.strptime(endDate, "%Y-%m-%d").strftime('%Y-%m-%d')
        # query = query + " where record_date >= '{0}' and record_date <= '{1}'".format(startDate, endDate)                
        db_response = PatientNotes.objects.raw("select id, count(*) as all_count, (history like '%__-year-old male %' or history like '%__-year-old m %' or history like '% y.o.m %' or history like '%y.o. m %' or history like '%yo m %' or history like '% yo man %' or history like '% yo male %' or history like '%yo m,%' or history like '%yo male,%' or history like '% y/o m %' or history like '% y/o male %' or history like '% yo/m %' or history like '% male %' or history like '%yom %' or history like '%year old m %' or history like '%yo m. %' or history like '%yo young man %' or history like '%yo, m %' or history like '% m %' or history like '% yo, m,%' or history like '%yo man %' or history like '%old man %' or history like '%y/o man %' or history like '%yM %' or history like '%year old man %' or history like '%yearold man %' or history like '%with girlfriend%' or history like '%yo boy%') and history not like '%periods%') and (record_date >= '{0}' and record_date <= '{1}')) as male_count,(select count(*) from reports_patientnotes where (history like '%__-year-old female%' or history like '%__-year-old f %' or history like '% y.o.f %' or history like '%yo f %' or history like '% yo woman%' or history like '% yo women%' or history like '% yo female%' or history like '% yo f,%' or history like '% y/o f %' or history like '% y/o female%' or history like '% yo/f %' or history like '%y.o. f %' or history like '%yof %' or history like '%year old f %' or history like '%yo f.%' or history like '%yo, f %' or history like '% f %' or history like '% yo, f,%' or history like '%old lady%' or history like '%yo, f,%' or history like '%yo lady%' or history like '%old woman%' or history like '%y/o woman%' or history like '%yF %' or history like '%periods%' or history like '%with boyfriend%'  or history like '%menstrual%'  or history like '%with husband%') and (record_date >= '{0}' and record_date <= '{1}')) as female_count from reports_patientnotes limit 1".format(startDate, endDate))[0]
    elif(startDate != "" and endDate == ""):
        # startDate = datetime.strptime(startDate, "%Y-%m-%d").strftime('%Y-%d-%m')
        # query = query + " where record_date >= '{0}'".format(startDate)
        db_response = PatientNotes.objects.raw("select id, (select count(*) from reports_patientnotes where (history like '%__-year-old male %' or history like '%__-year-old m %' or history like '% y.o.m %' or history like '%y.o. m %' or history like '%yo m %' or history like '% yo man %' or history like '% yo male %' or history like '%yo m,%' or history like '%yo male,%' or history like '% y/o m %' or history like '% y/o male %' or history like '% yo/m %' or history like '% male %' or history like '%yom %' or history like '%year old m %' or history like '%yo m. %' or history like '%yo young man %' or history like '%yo, m %' or history like '% m %' or history like '% yo, m,%' or history like '%yo man %' or history like '%old man %' or history like '%y/o man %' or history like '%yM %' or history like '%year old man %' or history like '%yearold man %' or history like '%with girlfriend%' or history like '%yo boy%') and history not like '%periods%') and (record_date >= '{0}')) as male_count,(select count(*) from reports_patientnotes where (history like '%__-year-old female%' or history like '%__-year-old f %' or history like '% y.o.f %' or history like '%yo f %' or history like '% yo woman%' or history like '% yo women%' or history like '% yo female%' or history like '% yo f,%' or history like '% y/o f %' or history like '% y/o female%' or history like '% yo/f %' or history like '%y.o. f %' or history like '%yof %' or history like '%year old f %' or history like '%yo f.%' or history like '%yo, f %' or history like '% f %' or history like '% yo, f,%' or history like '%old lady%' or history like '%yo, f,%' or history like '%yo lady%' or history like '%old woman%' or history like '%y/o woman%' or history like '%yF %' or history like '%periods%' or history like '%with boyfriend%'  or history like '%menstrual%'  or history like '%with husband%') and (record_date >= '{0}')) as female_count from reports_patientnotes limit 1".format(startDate))[0]
    elif(startDate == "" and endDate != ""):
        # endDate = datetime.strptime(endDate, "%Y-%m-%d").strftime('%Y-%d-%m')
        # query = query + " where record_date <= '{0}'".format(endDate)
        db_response = PatientNotes.objects.raw("select id, count(*) as all_count, (select count(*) from reports_patientnotes where (history like '%__-year-old male %' or history like '%__-year-old m %' or history like '% y.o.m %' or history like '%y.o. m %' or history like '%yo m %' or history like '% yo man %' or history like '% yo male %' or history like '%yo m,%' or history like '%yo male,%' or history like '% y/o m %' or history like '% y/o male %' or history like '% yo/m %' or history like '% male %' or history like '%yom %' or history like '%year old m %' or history like '%yo m. %' or history like '%yo young man %' or history like '%yo, m %' or history like '% m %' or history like '% yo, m,%' or history like '%yo man %' or history like '%old man %' or history like '%y/o man %' or history like '%yM %' or history like '%year old man %' or history like '%yearold man %' or history like '%with girlfriend%' or history like '%yo boy%') and history not like '%periods%') and (record_date <= '{0}')) as male_count,(select count(*) from reports_patientnotes where (history like '%__-year-old female%' or history like '%__-year-old f %' or history like '% y.o.f %' or history like '%yo f %' or history like '% yo woman%' or history like '% yo women%' or history like '% yo female%' or history like '% yo f,%' or history like '% y/o f %' or history like '% y/o female%' or history like '% yo/f %' or history like '%y.o. f %' or history like '%yof %' or history like '%year old f %' or history like '%yo f.%' or history like '%yo, f %' or history like '% f %' or history like '% yo, f,%' or history like '%old lady%' or history like '%yo, f,%' or history like '%yo lady%' or history like '%old woman%' or history like '%y/o woman%' or history like '%yF %' or history like '%periods%' or history like '%with boyfriend%'  or history like '%menstrual%'  or history like '%with husband%') and (record_date <= '{0}')) as female_count from reports_patientnotes limit 1".format(endDate))[0]
    else:
        db_response = PatientNotes.objects.raw("select id, count(*) as all_count, (select count(*) from reports_patientnotes where (history like '%__-year-old male %' or history like '%__-year-old m %' or history like '% y.o.m %' or history like '%y.o. m %' or history like '%yo m %' or history like '% yo man %' or history like '% yo male %' or history like '%yo m,%' or history like '%yo male,%' or history like '% y/o m %' or history like '% y/o male %' or history like '% yo/m %' or history like '% male %' or history like '%yom %' or history like '%year old m %' or history like '%yo m. %' or history like '%yo young man %' or history like '%yo, m %' or history like '% m %' or history like '% yo, m,%' or history like '%yo man %' or history like '%old man %' or history like '%y/o man %' or history like '%yM %' or history like '%year old man %' or history like '%yearold man %' or history like '%with girlfriend%' or history like '%yo boy%') and history not like '%periods%') as male_count,(select count(*) from reports_patientnotes where history like '%__-year-old female%' or history like '%__-year-old f %' or history like '% y.o.f %' or history like '%yo f %' or history like '% yo woman%' or history like '% yo women%' or history like '% yo female%' or history like '% yo f,%' or history like '% y/o f %' or history like '% y/o female%' or history like '% yo/f %' or history like '%y.o. f %' or history like '%yof %' or history like '%year old f %' or history like '%yo f.%' or history like '%yo, f %' or history like '% f %' or history like '% yo, f,%' or history like '%old lady%' or history like '%yo, f,%' or history like '%yo lady%' or history like '%old woman%' or history like '%y/o woman%' or history like '%yF %' or history like '%periods%' or history like '%with boyfriend%'  or history like '%menstrual%'  or history like '%with husband%') as female_count from reports_patientnotes limit 1")[0]
